...
export const testNodeServerSdk = async () => {
  try {
    await sdk.initialize({
      ...
      apiToken: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ0ZW5hbnRJZCI6IjgxZjZjNzljLTg4ZjQtNDI5YS1iY2VlLWY1NmFjNTE5NGJiYSIsImlhdCI6MTY3NDEzNTU0NX0.Lxyny0O9oX_cCRGLWpTQyDtHTwb1hdM7tydsGVyhIX8',
      evaluationHooks: {
  ...
  await sdk.updateCustomerFeatures('105ce4c9-7674-4482-91a5-7fa2f2453a94', {key: 'ry', value: 'lalalalal'});
};
