...
Features are the basic buildings blocks of Enrolla.
...
- A `default value`, which is the value this feature will be set to for all customers unless otherwise overridden.
...
<Note>
  Here that you can also override any package defaults, to make customizations
